...
var title = 'The Course of All Treasons';
var pages = 268;
...
// these instructions are a little confusing.
...
if (isFavorite) {
    ...
    console.log(`I recently read the book, ${title}.`); // I changed a tiny bit of grammar so it would make sense.
}
...
var books = ['The Course of All Treasons', 'Diana', 'Sarah Jane', 'The Art of Dying', 'Super Sushi Ramen Express'];
...
var belowTwoHundred = [21, 42, 199, 102, 57, 148, 11, 134, 212, 77, 113, 244];
